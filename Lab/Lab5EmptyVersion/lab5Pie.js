...
function drawPie(salaryData,projectList,pieSvg){
    ...
    var tip = d3.tip()
          ...
          .offset([-10, 0])
          .html(function(d,i) {
            return "<strong>"+projectList[i]+"</strong> <span style='color:red'>" +d.data+ "</span>";//your work here
          })
    ...
    for (idx in salaryData){
        ...
        aPieChart.append("text")
                 .text(employee.name)//your work here
                 .attr("x",cx)//your work here
                 .attr("y",cy+radius+5)//your work here //set the title on the bottom of the subchart.
